...
public class IntroSwingController implements Initializable {
	@FXML
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		ToolTipCustom cell1tt = new ToolTipCustom("dasdadasdasdasdasdasdasdasdczxvsdvgrotjhiorhbomyhmvsdsd", 100,
				344 + cell1.getPrefHeight() + 10);
		...
		// 1 đoạn
		ToolTipCustom objecttt = new ToolTipCustom(
				"Đây là lớp cha của mọi class.\nTất cả mọi class đều có \"Object\" như là lớp cha.", 442, 766);
		...
		// 1 đoạn
		ToolTipCustom componenttt = new ToolTipCustom(
				"Đối tượng được dùng để biểu diễn đồ họa trên màn hình\nmà người dùng có thể tương tác được.",
				336 + 96 + 10, 875);
		...
		//
		ToolTipCustom containertt = new ToolTipCustom("Đây là Component dùng để chứa các Component khác", 212 + 96 + 10,
				1021);
		...
		ToolTipCustom jcomponenttt = new ToolTipCustom(
				"Lớp cơ sở cho tất cả các Swing component trừ \ncác cấp cao hơn.", 479 + 96 + 10, 1021);
		...
		ToolTipCustom windowtt = new ToolTipCustom(
				"Đây là cửa sổ cao nhất không có đường viền, không có thanh menu \nvà thường là khung hình chữ nhật.",
				118 + 96 + 10, 1160);
		...
		ToolTipCustom paneltt = new ToolTipCustom(
				"Đây là lớp Container đơn giản nhất, cung cấp không gian cho ứng\ndụng đính kèm bất kỳ component khác bao gồm các Panel khác.",
				346 + 96 + 10, 1160);
		...
		ToolTipCustom framett = new ToolTipCustom("Đây là cửa sổ có tiêu đề và khung viền.", 26 + 96 + 10, 1319);
		...
		ToolTipCustom dialogtt = new ToolTipCustom(
				"Đây là cửa sổ có tiêu đề và khung viền nhưng thường sử\ndụng để lấy một số hình thức đầu vào của người dùng.",
				208 + 96 + 10, 1319);
		...
		ToolTipCustom applettt = new ToolTipCustom(
				"Đây là một chương trình nhỏ được thiết kế ra nhằm\nnhúng bên trong ứng dụng khác thường là Webpage.",
				346 + 96 + 10, 1276);
		...
		ToolTipCustom jlisttt = new ToolTipCustom(
				"Component hiển thị danh sách các đối tượng \nvà cho phép người dùng chọn một hay nhiều\nmục.", 407,
				845);
		...
		ToolTipCustom jtablett = new ToolTipCustom(
				"Được sử dụng để hiện thị và chỉnh sửa trên các ô\ncủa bảng 2 chiều.", 390, 924);
		...
		ToolTipCustom jcomboboxtt = new ToolTipCustom(
				"Component kết hợp một drop-down list với một\nbutton hoặc một vùng có thể điền vào được.", 392, 1003);
		...
		ToolTipCustom jslidertt = new ToolTipCustom(
				"Component cho phép người dùng lựa chọn một\ngiá trị trong một dãy cụ thể giới hạn bằng một\ncon trượt.",
				394, 1082);
		...
		ToolTipCustom jmenutt = new ToolTipCustom(
				"Cửa sổ bật lên hiện thị các JMenuItem khi\nngười dùng chọn một mục trên JMenuBar.", 427, 1161);
		...
		ToolTipCustom jabstractbuttontt = new ToolTipCustom(
				"Định nghĩa các hành vi phổ biến cho Button và\ncác MenuItem.", 404, 1240);
		...
		ToolTipCustom jbuttontt = new ToolTipCustom(
				"Tạo nút \"push\" có thể chỉnh cấu hình ở\nmức độ nào đó bởi Actions.", 450, 1327);
